    ...
    public class DataAccess : Helpers
    {
        ...
        public List<ArborStratix> Get_Arbors (string job)
        {
            ...
            catch(OdbcException ex)
            {
                ...
                Console.WriteLine("arbor odbc ex: " + ex.InnerException.ToString());
            }
            catch(Exception ex)
            {
        ...
        public List<Consume> Get_Consumed(string job)
        {
            ...
            catch (OdbcException ex)
            {
                ...
                Console.WriteLine("consume odbc ex: " + ex.InnerException.ToString());
            }
            catch (Exception ex)
            {
        ...
        public List<SO> Get_SOs(string job)
        {
            ...
            catch (OdbcException ex)
            {
                ...
                Console.WriteLine("SO odbc ex: " + ex.InnerException.ToString());
            }
            catch (Exception ex)
            {
